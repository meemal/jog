                    ...
                    <nav class="flex flex-col sm:flex-row">
                        <?php foreach ($filtered_tabs as $tab) : ?>
                            <button data-tab="<?php echo esc_attr($tab['id']); ?>" 
                                    class="tab-button text-[28px] text-dark-grey font-artz hover:text-mill-red-high pb-[30px] lg:pb-[39.5px] relative px-[36px] 
                                    ...
                                    <?php echo ($tab['id'] === $first_tab_id) ? ' text-mill-red border-b-[4px] border-mill-red' : ''; ?>"
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    buttons.forEach(btn => {
                        btn.addEventListener('click', function () {
                            ...
                            buttons.forEach(b => b.classList.remove('text-mill-red', 'border-b-[4px]', 'border-mill-red'));
                            this.classList.add('text-mill-red', 'border-b-[4px]', 'border-mill-red');
